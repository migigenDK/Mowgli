...
#define MOTOR_PID_KP     1.0    // 0.5 do not change 2.0 (for non-Ardumower motors or if the motor speed control is too fast you may try: KP=1.0, KI=0, KD=0)
#define MOTOR_PID_KI     0.0   // 0.01 do not change 0.03
#define MOTOR_PID_KD     0.0   // 0.01 do not change 0.03
...
#define NTRIP_HOST "3.143.243.81"   // RTK2GO
#define NTRIP_PORT 2101
#define NTRIP_MOUNT "SDS_RTK"
#define NTRIP_USER "migigenDK@gmail.com"
#define NTRIP_PASS ""
...
#define MQTT_SERVER  "192.168.1.4"                 // your MQTT broker IP or hostname (e.g. "broker.mqtt-dashboard.com")
#define MQTT_PORT  1883
#define MQTT_USER "MqttUser"
#define MQTT_PASS "ikke9igen6"
